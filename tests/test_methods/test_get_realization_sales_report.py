...
class TestGetRealizationSalesReport:
    async def test_get_realization_sales_report(self, api: MockedAPI) -> None:
        ...
        assert result[0].realizationreport_id == 1234567
        assert result[0].date_from == "2022-10-17"
        assert result[0].date_to == "2022-10-23"
        assert result[0].create_dt == "2022-10-24"
