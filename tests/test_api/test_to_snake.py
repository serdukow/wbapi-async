...
class TestToSnake:
    ...
    def test_nested_not_converted(self) -> None:
        r = WBType({"orderId": 1, "meta": {"nmId": 2}})
        result = r.to_snake()
    ...
    def test_values_preserved(self) -> None:
        r = WBType({"advertId": None, "nmId": 0, "name": ""})
