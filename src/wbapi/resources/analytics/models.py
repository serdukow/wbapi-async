...
class StocksReportOfficesCreateResponse(WBModel):
    data: TableShippingOfficeResponse | None = _field(default=None)


class StocksReportProductsGroupsCreateResponse(WBModel):
    data: TableGroupResponseSt | None = _field(default=None)


class StocksReportProductsProductsCreateResponse(WBModel):
    data: TableItemResponse | None = _field(default=None)


class StocksReportProductsSizesCreateResponse(WBModel):
...
class V1OrderFeedPagination(WBModel):
    """Пагинация"""
...
class V1OrderFeedResponse(WBModel):
    data: OrderFeedResponse | None = _field(default=None)


class V1OrderFeedSelectedPeriod(WBModel):
    """Запрашиваемый период. По дате текущего статуса заказа"""
...
class V1StocksReportWbWarehousesCreateResponse(WBModel):
    data: InventoryWbResponse | None = _field(default=None)


class V2ItemRatingResponse(WBModel):
    data: ItemRatingResponse | None = _field(default=None)


class V3SalesFunnelGroupedHistoryCreateResponse(WBModel):
    data: list[V3SalesFunnelGroupedHistoryCreateResponseDataItem] | None = _field(default=None)


class V3SalesFunnelGroupedHistoryCreateResponseDataItem(WBModel):
...
class V3SalesFunnelProductsCreateResponse(WBModel):
    data: dict[str, Any] | None = _field(default=None)


class V3SalesFunnelProductsHistoryCreateResponseItem(WBModel):
    currency: str | None = _field(default=None)
