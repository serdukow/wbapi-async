...
class NmReportDownloads(WBMethod[NmReportGetReportsResponse]):
...
class NmReportDownloadsCreate(WBMethod[NmReportCreateReportResponse]):
    """Создать отчёт
...
class NmReportDownloadsFileDownloadId(WBMethod[None]):
    """Получить отчёт
...
class NmReportDownloadsRetryCreate(WBMethod[NmReportRetryReportResponse]):
...
class SearchReportProductOrdersCreate(WBMethod[CommonResponseProperties]):
...
class SearchReportProductSearchTextsCreate(WBMethod[CommonResponseProperties]):
...
class SearchReportReportCreate(WBMethod[CommonResponseProperties]):
    """Основная страница
...
class SearchReportTableDetailsCreate(WBMethod[CommonResponseProperties]):
...
class SearchReportTableGroupsCreate(WBMethod[CommonResponseProperties]):
...
class StocksReportOfficesCreate(WBMethod[StocksReportOfficesCreateResponse]):
    """Данные по складам
    ...
    __http_method__ = "POST"
    __returns__ = StocksReportOfficesCreateResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (20000, 3),
...
class StocksReportProductsGroupsCreate(WBMethod[StocksReportProductsGroupsCreateResponse]):
    """Данные по группам
    ...
    __http_method__ = "POST"
    __returns__ = StocksReportProductsGroupsCreateResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (20000, 3),
...
class StocksReportProductsProductsCreate(WBMethod[StocksReportProductsProductsCreateResponse]):
    """Данные по товарам
    ...
    __http_method__ = "POST"
    __returns__ = StocksReportProductsProductsCreateResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (20000, 3),
...
class StocksReportProductsSizesCreate(WBMethod[StocksReportProductsSizesCreateResponse]):
    """Данные по размерам
    ...
    __http_method__ = "POST"
    __returns__ = StocksReportProductsSizesCreateResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (20000, 3),
...
class V1OrderFeed(WBMethod[V1OrderFeedResponse]):
    """Получить отчёт
    ...
    __http_method__ = "POST"
    __returns__ = V1OrderFeedResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (60000, 1),
...
class V1StocksReportWbWarehousesCreate(WBMethod[V1StocksReportWbWarehousesCreateResponse]):
    ...
    __http_method__ = "POST"
    __returns__ = V1StocksReportWbWarehousesCreateResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
...
class V2ItemRating(WBMethod[V2ItemRatingResponse]):
    """Получить отчёт
    ...
    __http_method__ = "POST"
    __returns__ = V2ItemRatingResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
...
class V3SalesFunnelGroupedHistoryCreate(WBMethod[V3SalesFunnelGroupedHistoryCreateResponse]):
    ...
    __http_method__ = "POST"
    __returns__ = V3SalesFunnelGroupedHistoryCreateResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (20000, 3),
...
class V3SalesFunnelProductsCreate(WBMethod[V3SalesFunnelProductsCreateResponse]):
    ...
    __http_method__ = "POST"
    __returns__ = V3SalesFunnelProductsCreateResponse
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (20000, 3),
...
class V3SalesFunnelProductsHistoryCreate(WBMethod[list[V3SalesFunnelProductsHistoryCreateResponseItem]]):
    ...
    __http_method__ = "POST"
    __returns__ = list[V3SalesFunnelProductsHistoryCreateResponseItem]
    __scope__ = Scope.ANALYTICS
    __host__ = "https://seller-analytics-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (20000, 3),
