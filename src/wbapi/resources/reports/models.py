...
class AcceptanceReportTasksTaskIdDownloadResponseItem(WBModel):
...
class AnalyticsBannedProductsBlockedResponse(WBModel):
    report: list[AnalyticsBannedProductsBlockedResponseReportItem] | None = _field(default=None)
    """Отчёт"""


class AnalyticsBannedProductsBlockedResponseReportItem(WBModel):
...
class AnalyticsGoodsReturnResponse(WBModel):
    report: list[AnalyticsGoodsReturnResponseReportItem] | None = _field(default=None)
    """Отчёт"""


class AnalyticsGoodsReturnResponseReportItem(WBModel):
...
class PaidStorageTasksTaskIdDownloadResponseItem(WBModel):
    barcode: str | None = _field(default=None)
    """Баркод"""
...
class WarehouseRemainsTasksTaskIdDownloadResponseItem(WBModel):
    barcode: str | None = _field(default=None)
    """Баркод"""
    brand: str | None = _field(default=None)
    """Бренд"""
    ...
    volume: float | None = _field(default=None)
    """Объём, л"""
    warehouses: list[WarehouseRemainsTasksTaskIdDownloadResponseItemWarehousesItem] | None = _field(
        default=None
    )
    """Остатки на складах и товары в пути. Будут в ответе только при ненулевом `quantity`"""


class WarehouseRemainsTasksTaskIdDownloadResponseItemWarehousesItem(WBModel):
