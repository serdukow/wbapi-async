...
class OrdersOrderIdMetaUinUpdateBody(WBModel):
...
class OrdersResponse(WBModel):
    next: int | None = _field(default=None)
    orders: list[Order] | None = _field(default=None)


class OrdersStatusBody(WBModel):
    orders: list[int] | None = _field(default=None)
    """Список ID сборочных заданий"""


class OrdersStatusHistoryBody(WBModel):
    orders: list[int] | None = _field(default=None)
    """ID сборочных заданий"""


class OrdersStatusHistoryResponse(WBModel):
    orders: list[OrdersStatusHistoryResponseOrdersItem] | None = _field(default=None)
    """Список сборочных заданий"""


class OrdersStatusHistoryResponseOrdersItem(WBModel):
    delivery_date: str | None = _field(default=None, name="deliveryDate")
    """Планируемая дата доставки, RFC3339"""
    order_id: int | None = _field(default=None, name="orderID")
    """ID сборочного задания"""
    statuses: list[OrdersStatusHistoryResponseOrdersItemStatusesItem] | None = _field(default=None)
    """Статусы"""


class OrdersStatusHistoryResponseOrdersItemStatusesItem(WBModel):
...
class OrdersStatusResponse(WBModel):
    orders: list[OrdersStatusResponseOrdersItem] | None = _field(default=None)


class OrdersStatusResponseOrdersItem(WBModel):
    id: int | None = _field(default=None)
    """ID сборочного задания"""
...
class OrdersStickersBody(WBModel):
    orders: list[int] | None = _field(default=None)
    """Список ID сборочных заданий"""


class OrdersStickersCrossBorderBody(WBModel):
    orders: list[int] | None = _field(default=None)
    """Список ID сборочных заданий"""


class OrdersStickersCrossBorderResponse(WBModel):
    stickers: list[OrdersStickersCrossBorderResponseStickersItem] | None = _field(default=None)


class OrdersStickersCrossBorderResponseStickersItem(WBModel):
...
class OrdersStickersResponse(WBModel):
    stickers: list[OrdersStickersResponseStickersItem] | None = _field(default=None)


class OrdersStickersResponseStickersItem(WBModel):
    barcode: str | None = _field(default=None)
    """Закодированное значение стикера"""
    file: str | None = _field(default=None)
...
class PassesCreateBody(WBModel):
    car_model: str | None = _field(default=None, name="carModel")
    """Марка машины"""
    car_number: str | None = _field(default=None, name="carNumber")
    """Номер машины"""
...
class PassesCreateResponse(WBModel):
    id: int | None = _field(default=None)
    """ID пропуска продавца"""


class PassesPassIdUpdateBody(WBModel):
    car_model: str | None = _field(default=None, name="carModel")
    """Марка машины"""
    car_number: str | None = _field(default=None, name="carNumber")
    """Номер машины"""
...
class SettingsAutoreturnsItemsBody(WBModel):
    chrt_ids: list[int] | None = _field(default=None, name="chrtIds")
    """Список ID размеров товаров в системе WB"""


class SettingsAutoreturnsItemsResponse(WBModel):
    results: list[SettingsAutoreturnsItemsResponseResultsItem] | None = _field(default=None)


class SettingsAutoreturnsItemsResponseResultsItem(WBModel):
    changeable: bool | None = _field(default=None)
    """- `true` — настройки автовозврата товара можно изменить"""
    chrt_id: int | None = _field(default=None, name="chrtId")
    """ID размера товара в системе WB"""
    error: list[SettingsAutoreturnsItemsResponseResultsItemErrorItem] | None = _field(default=None)
    """Детали ошибки"""
...
class SettingsAutoreturnsItemsResponseResultsItemErrorItem(WBModel):
    code: Any | None = _field(default=None)
    """Код ошибки"""
...
class SettingsAutoreturnsItemsUpdateBody(WBModel):
    chrt_ids: list[int] | None = _field(default=None, name="chrtIds")
    """Список ID размеров товаров в системе WB"""
    type: str | None = _field(default=None)
...
class SettingsAutoreturnsItemsUpdateResponse(WBModel):
    results: list[SettingsAutoreturnsItemsUpdateResponseResultsItem] | None = _field(default=None)


class SettingsAutoreturnsItemsUpdateResponseResultsItem(WBModel):
    chrt_id: int | None = _field(default=None, name="chrtId")
    """ID размера товара в системе WB"""
...
class SettingsAutoreturnsResponse(WBModel):
    type: str | None = _field(default=None)
...
class SettingsAutoreturnsSubcategoriesRestrictedResponse(WBModel):
    data: list[SettingsAutoreturnsSubcategoriesRestrictedResponseDataItem] | None = _field(default=None)
...
class SettingsAutoreturnsSubcategoriesRestrictedResponseDataItem(WBModel):
    subject_id: int | None = _field(default=None, name="subjectId")
    """ID предмета"""


class SettingsAutoreturnsUpdateBody(WBModel):
    type: str | None = _field(default=None)
    """Тип автовозврата малогабаритных товаров: …"""


class SuppliesCreateBody(WBModel):
    name: str | None = _field(default=None)
    """Наименование поставки"""


class SuppliesCreateResponse(WBModel):
    id: str | None = _field(default=None)
    """ID поставки"""


class SuppliesOrdersReshipmentResponse(WBModel):
    orders: list[SuppliesOrdersReshipmentResponseOrdersItem] | None = _field(default=None)
    """Список сборочных заданий"""


class SuppliesOrdersReshipmentResponseOrdersItem(WBModel):
...
class SuppliesResponse(WBModel):
    next: int | None = _field(default=None)
    supplies: list[Supply] | None = _field(default=None)
    """Список поставок"""


class SuppliesSupplyIdBarcodeResponse(WBModel):
    barcode: str | None = _field(default=None)
