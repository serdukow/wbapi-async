...
class Catalog(WBMethod[GetFullCatalogResponse]):
...
class ContentAuthor(WBMethod[ContentList]):
...
class ContentAuthorContentId(WBMethod[Content]):
...
class ContentAuthorContentIdUpdate(WBMethod[Content]):
...
class ContentDelete(WBMethod[None]):
    """Удалить контент
...
class ContentDownloadUri(WBMethod[None]):
    """Скачать контент
...
class ContentGalleryCreate(WBMethod[UploadGalleryResponse]):
...
class ContentIllustrationCreate(WBMethod[IllustrationResponse]):
...
class ContentUploadChunkCreate(WBMethod[UploadChunkResponse]):
...
class ContentUploadInitCreate(WBMethod[UploadInitResponse]):
...
class KeysApiKeysCreate(WBMethod[None]):
...
class KeysApiKeysDelete(WBMethod[KeysDeleteResponse]):
...
class KeysApiKeysRedeemed(WBMethod[KeysRedeemedResponseList]):
...
class OfferKeysOfferId(WBMethod[KeysCountResponse]):
...
class OfferKeysOfferIdList(WBMethod[KeysResponseList]):
...
class OfferOfferIdUpdate(WBMethod[None]):
    """Обновить статус
...
class OfferPriceOfferIdUpdate(WBMethod[None]):
    """Обновить цену
...
class OffersAuthor(WBMethod[OfferResponseList]):
...
class OffersCreate(WBMethod[OfferResponse]):
...
class OffersOfferId(WBMethod[OfferResponse]):
...
class OffersOfferIdUpdate(WBMethod[None]):
...
class OffersThumbCreate(WBMethod[None]):
