...
class CommonV1Rating(WBMethod[SupplierRatingModel]):
...
class CommonV1Subscriptions(WBMethod[SubscriptionsJamInfo]):
...
class CommonV1TariffConstructorOptions(WBMethod[PlanBuilderOptionsInfo]):
...
class CommunicationsV2News(WBMethod[CommunicationsV2NewsResponse]):
    ...
    __http_method__ = "GET"
    __returns__ = CommunicationsV2NewsResponse
...
class InviteCreate(WBMethod[CreateInviteResponse]):
    ...
    invite: InviteCreateInvite
    access: list[InviteCreateAccessItem] | None = None
...
class SellerInfo(WBMethod[SellerInfoResponse]):
    ...
    __http_method__ = "GET"
    __returns__ = SellerInfoResponse
    __host__ = "https://common-api.wildberries.ru"
    __rate_limits__ = {
        "personal": (60000, 10),
        "service": (60000, 10),
...
class UserDelete(WBMethod[None]):
...
class Users(WBMethod[GetUsersResponse]):
...
class UsersAccessUpdate(WBMethod[None]):
