...
class AccountBalance(WBMethod[AccountBalanceResponse]):
    ...
    __http_method__ = "GET"
    __returns__ = AccountBalanceResponse
...
class DocumentsCategories(WBMethod[GetCategories]):
...
class DocumentsDownload(WBMethod[GetDoc]):
    """Получить документ
...
class DocumentsDownloadAll(WBMethod[GetDocs]):
    """Получить документы
    ...
    params: list[DocumentsDownloadAllParamsItem] | None = None


class DocumentsList(WBMethod[GetList]):
    """Список документов
...
class FinanceV1AcquiringDetailedCreate(WBMethod[list[AcquiringReportsDetailedRes]]):
...
class FinanceV1AcquiringDetailedReportIdCreate(WBMethod[list[AcquiringReportsDetailedRes]]):
...
class FinanceV1AcquiringList(WBMethod[list[AcquiringReportListRes]]):
...
class FinanceV1SalesReportsDetailedCreate(WBMethod[list[SalesReportsDetailedRes]]):
...
class FinanceV1SalesReportsDetailedReportIdCreate(WBMethod[list[SalesReportsDetailedRes]]):
...
class FinanceV1SalesReportsList(WBMethod[list[SalesReportListRes]]):
