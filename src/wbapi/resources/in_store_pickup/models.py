...
class ClickCollectOrdersMetaCustomsDeclarationUpdateBody(WBModel):
    orders: list[ClickCollectOrdersMetaCustomsDeclarationUpdateBodyOrdersItem] | None = _field(default=None)


class ClickCollectOrdersMetaCustomsDeclarationUpdateBodyOrdersItem(WBModel):
...
class ClickCollectOrdersMetaCustomsDeclarationUpdateOrdersItem(WBModel):
    customs_declaration: str | None = _field(default=None, name="customsDeclaration")
    """Номер ДТ"""
    order_id: int | None = _field(default=None, name="orderId")
    """ID сборочного задания"""
