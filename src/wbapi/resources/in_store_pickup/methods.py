...
class ClickCollectOrders(WBMethod[ApiOrders]):
...
class ClickCollectOrdersClient(WBMethod[ApiOrderClientInfoResp]):
...
class ClickCollectOrdersClientIdentity(WBMethod[ApiCheckedIdentity]):
...
class ClickCollectOrdersFinalPrice(WBMethod[ApiOrdersFinalPriceResponse]):
...
class ClickCollectOrdersMetaCustomsDeclarationUpdate(WBMethod[ApiCustomsDeclarationSetResponse]):
    ...
    orders: list[ClickCollectOrdersMetaCustomsDeclarationUpdateOrdersItem]


class ClickCollectOrdersMetaDelete(WBMethod[ApiOrdersResponses]):
...
class ClickCollectOrdersMetaDetails(WBMethod[ApiOrdersMetaDetailsResponse]):
...
class ClickCollectOrdersMetaGtinUpdate(WBMethod[ApiMetaSetResponses]):
...
class ClickCollectOrdersMetaImeiUpdate(WBMethod[ApiMetaSetResponses]):
...
class ClickCollectOrdersMetaSgtinUpdate(WBMethod[ApiMetaSetResponses]):
...
class ClickCollectOrdersMetaUinUpdate(WBMethod[ApiMetaSetResponses]):
...
class ClickCollectOrdersNew(WBMethod[ApiNewOrders]):
...
class ClickCollectOrdersStatusCancel(WBMethod[ApiStatusSetResponses]):
...
class ClickCollectOrdersStatusConfirmUpdate(WBMethod[ApiStatusSetResponses]):
...
class ClickCollectOrdersStatusInfo(WBMethod[ApiOrderStatusesV2]):
...
class ClickCollectOrdersStatusPrepareCreate(WBMethod[ApiMetaDetailsResponse]):
...
class ClickCollectOrdersStatusReceiveCreate(WBMethod[ApiStatusSetResponses]):
...
class ClickCollectOrdersStatusRejectCreate(WBMethod[ApiStatusSetResponses]):
