...
class GroupsInfoResponseItem(WBModel):
...
class OrdersMetaCustomsDeclarationUpdateBody(WBModel):
    orders: list[OrdersMetaCustomsDeclarationUpdateBodyOrdersItem] | None = _field(default=None)


class OrdersMetaCustomsDeclarationUpdateBodyOrdersItem(WBModel):
...
class OrdersMetaCustomsDeclarationUpdateOrdersItem(WBModel):
    customs_declaration: str | None = _field(default=None, name="customsDeclaration")
    """Номер ДТ"""
    order_id: int | None = _field(default=None, name="orderId")
    """ID сборочного задания"""
...
class OrdersStatusReceiveCreateResponse(WBModel):
    request_id: str | None = _field(default=None, name="requestId")
    """Уникальный ID запроса"""
    results: list[OrdersStatusReceiveCreateResponseResultsItem] | None = _field(default=None)


class OrdersStatusReceiveCreateResponseResultsItem(WBModel):
    errors: list[OrdersStatusReceiveCreateResponseResultsItemErrorsItem] | None = _field(default=None)
    """Детали ошибки"""
    is_error: bool | None = _field(default=None, name="isError")
    """Есть ли ошибки"""
    order_id: int | None = _field(default=None, name="orderId")
...
class OrdersStatusReceiveCreateResponseResultsItemErrorsItem(WBModel):
    code: Any | None = _field(default=None)
    """Код ошибки"""
    detail: Any | None = _field(default=None)
    """- `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для
