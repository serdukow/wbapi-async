...
class Reports:
    ...
    async def get_supplier_orders(self, *, date_from: str, flag: int | None = None) -> list[OrdersItem]:
        """Заказы
    ...
    async def get_supplier_sales(self, *, date_from: str, flag: int | None = None) -> list[SalesItem]:
        """Продажи
