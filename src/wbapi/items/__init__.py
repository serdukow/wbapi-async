...
from .methods import (
    ...
    CreateContentCardsUpload,
    CreateContentCardsUploadAdd,
    CreateContentTag,
    CreateContentTagNomenclatureLink,
    CreateWarehouse,
    DeleteContentTag,
    DeleteStock,
    DeleteWarehouse,
    ...
    GetBufferTasks,
    GetContentBrands,
    GetContentCardsErrorList,
    GetContentCardsLimits,
    GetContentCardsList,
    GetContentCardsTrash,
    ...
    GetContentObjectAll,
    GetContentObjectCharcs,
    GetContentObjectParentAll,
    GetContentRecommendationsList,
    GetContentTags,
    ...
    SetUploadTaskSize,
    UpdateContentCard,
    UpdateContentCardsDeleteTrash,
    UpdateContentCardsMoveNm,
    UpdateContentCardsRecover,
    UpdateContentTag,
    UpdateDbwWarehousesContact,
    UpdateStock,
    UpdateWarehouse,
    UploadContentMediaFile,
    UploadContentMediaSave,
)
from .models import (
    BrandsResponse,
...
class Items:
    ...
    async def create_content_barcode(self, *, count: int | None = None) -> CreateContentBarcodeResponse:
        """Генерация баркодов

        :param count: Кол-во баркодов которые надо сгенерировать, максимальное доступное количество баркодов
            для генерации - `5 000`
        """
        return await CreateContentBarcode(count=count).emit(self._api)

    async def create_content_cards_upload(self, *, body: Any) -> ResponseItemList:
        """Создание карточек товаров"""
        return await CreateContentCardsUpload(body=body).emit(self._api)

    async def create_content_cards_upload_add(
        self,
        *,
        ...
        """
        return await CreateContentCardsUploadAdd(cards_to_add=cards_to_add, imt_id=imt_id).emit(self._api)
    ...
    async def create_content_tag(
        ...
        """
        return await CreateContentTag(color=color, name=name).emit(self._api)

    async def create_content_tag_nomenclature_link(
        ...
        """
        return await CreateContentTagNomenclatureLink(nm_id=nm_id, tags_ids=tags_ids).emit(self._api)
    ...
    async def delete_content_tag(self, *, id_: str | int) -> ResponseContentError:
        """Удаление ярлыка

        :param id_: Числовой ID ярлыка
        """
        return await DeleteContentTag(id_=id_).emit(self._api)
    ...
    async def get_content_brands(
        ...
        :param auto_paginate: автоматически собрать все страницы выборки
        """
        call = GetContentBrands(subject_id=subject_id, next_=next_)
        return await call.paginate(self._api) if auto_paginate else await call.emit(self._api)

    async def iter_get_content_brands(
        ...
        :param next_: Параметр пагинации. Используйте значение `next` из ответа, чтобы получить следующий
            пакет данных
        """
        async for item in GetContentBrands(subject_id=subject_id, next_=next_).stream(self._api):
            yield item

    async def get_content_cards_error_list(
        self,
        *,
        ...
        :param auto_paginate: автоматически собрать все страницы выборки
        """
        call = GetContentCardsErrorList(cursor=cursor, locale=locale, order=order)
        return await call.paginate(self._api) if auto_paginate else await call.emit(self._api)

    async def iter_get_content_cards_error_list(
        self,
        *,
        cursor: SwaggerPublicErrorsCursorInput | None = None,
        locale: str | None = None,
        ...
        :param locale: Язык названий предметов:   - `ru` — русский   - `en` — английский   - `zh` —
            китайский  Не используется в песочнице
        """
        async for item in GetContentCardsErrorList(cursor=cursor, locale=locale, order=order).stream(
            self._api
        ):
            yield item

    async def get_content_cards_limits(self) -> GetContentCardsLimitsResponse:
        """Лимиты карточек товаров"""
        return await GetContentCardsLimits().emit(self._api)

    async def get_content_cards_list(
        self,
        *,
        locale: str | None = None,
        settings: GetContentCardsListSettings | None = None,
        auto_paginate: bool = False,
    ) -> GetContentCardsListResponse | list[Any]:
        ...
        :param auto_paginate: автоматически собрать все страницы выборки
        """
        call = GetContentCardsList(locale=locale, settings=settings)
        return await call.paginate(self._api) if auto_paginate else await call.emit(self._api)

    async def iter_get_content_cards_list(
        self, *, locale: str | None = None, settings: GetContentCardsListSettings | None = None
    ) -> AsyncIterator[Any]:
        ...
        :param settings: Настройки
        """
        async for item in GetContentCardsList(locale=locale, settings=settings).stream(self._api):
            yield item

    async def get_content_cards_trash(
        self,
        *,
        locale: str | None = None,
        settings: GetContentCardsTrashSettings | None = None,
        auto_paginate: bool = False,
    ) -> GetContentCardsTrashResponse | list[Any]:
        ...
        :param auto_paginate: автоматически собрать все страницы выборки
        """
        call = GetContentCardsTrash(locale=locale, settings=settings)
        return await call.paginate(self._api) if auto_paginate else await call.emit(self._api)

    async def iter_get_content_cards_trash(
        self, *, locale: str | None = None, settings: GetContentCardsTrashSettings | None = None
    ) -> AsyncIterator[Any]:
        ...
        :param settings: Настройки
        """
        async for item in GetContentCardsTrash(locale=locale, settings=settings).stream(self._api):
            yield item

    async def get_content_directory_colors(
        ...
        :param locale: Язык полей ответа `subjectName` и `name`:   - `ru` — русский   - `en` — английский
            - `zh` — китайский …
        """
        return await GetContentDirectoryColors(locale=locale).emit(self._api)

    async def get_content_directory_countries(
        self, *, locale: str | None = None
    ) -> GetContentDirectoryCountriesResponse:
        """Страна производства
        ...
        :param locale: Язык полей ответа `subjectName` и `name`:   - `ru` — русский   - `en` — английский
            - `zh` — китайский …
        """
        return await GetContentDirectoryCountries(locale=locale).emit(self._api)

    async def get_content_directory_kinds(
        self, *, locale: str | None = None
    ) -> GetContentDirectoryKindsResponse:
        """Пол
        ...
        :param locale: Язык полей ответа `subjectName` и `name`:   - `ru` — русский   - `en` — английский
            - `zh` — китайский …
        """
        return await GetContentDirectoryKinds(locale=locale).emit(self._api)

    async def get_content_directory_seasons(
        self, *, locale: str | None = None
    ) -> GetContentDirectorySeasonsResponse:
        """Сезон
        ...
        :param locale: Язык полей ответа `subjectName` и `name`:   - `ru` — русский   - `en` — английский
            - `zh` — китайский …
        """
        return await GetContentDirectorySeasons(locale=locale).emit(self._api)

    async def get_content_directory_tnved(
        ...
        """
        return await GetContentDirectoryTnved(subject_id=subject_id, locale=locale, search=search).emit(
            self._api
        )

    async def get_content_directory_vat(self, *, locale: str | None = None) -> GetContentDirectoryVatResponse:
        """Ставка НДС

        :param locale: Язык полей ответа `subjectName` и `name`:   - `ru` — русский   - `en` — английский
            - `zh` — китайский …
        """
        return await GetContentDirectoryVat(locale=locale).emit(self._api)

    async def get_content_object_all(
        self,
        *,
        limit: int | None = None,
        locale: str | None = None,
        ...
        auto_paginate: bool = False,
    ) -> GetContentObjectAllResponse | list[Any]:
        """Список предметов
        ...
        :param auto_paginate: автоматически собрать все страницы выборки
        """
        call = GetContentObjectAll(limit=limit, locale=locale, name=name, offset=offset, parent_id=parent_id)
        return await call.paginate(self._api) if auto_paginate else await call.emit(self._api)

    async def iter_get_content_object_all(
        self,
        *,
        limit: int | None = None,
        locale: str | None = None,
        ...
        :param parent_id: ID родительской категории предмета
        """
        async for item in GetContentObjectAll(
            limit=limit, locale=locale, name=name, offset=offset, parent_id=parent_id
        ).stream(self._api):
            yield item

    async def get_content_object_charcs(
        ...
        :param locale: Язык полей ответа `subjectName` и `name`:   - `ru` — русский   - `en` — английский
            - `zh` — китайский …
        """
        return await GetContentObjectCharcs(subject_id=subject_id, locale=locale).emit(self._api)

    async def get_content_object_parent_all(
        self, *, locale: str | None = None
    ) -> GetContentObjectParentAllResponse:
        ...
        :param locale: Язык поля ответа `name`:   - `ru` — русский   - `en` — английский   - `zh` —
            китайский …
        """
        return await GetContentObjectParentAll(locale=locale).emit(self._api)

    async def get_content_recommendations_list(
        self,
        *,
    ...
    async def iter_get_content_recommendations_list(
        ...
        *,
        ...
        :param subject_ids: ID предметов
        """
        async for item in GetContentRecommendationsList(
            brand_names=brand_names, limit=limit, next_=next_, search=search, subject_ids=subject_ids
        ).stream(self._api):
            yield item

    async def get_content_tags(self) -> GetContentTagsResponse:
        """Список ярлыков"""
        return await GetContentTags().emit(self._api)
    ...
    async def set_content_recommendation(
        self, *, rec_list: list[SetContentRecommendationRecListItem], replace: bool | None = None
    ) -> SetRecomRes:
        ...
        """
        return await SetContentRecommendation(rec_list=rec_list, replace=replace).emit(self._api)
    ...
    async def update_content_card(self, *, body: Any) -> ResponseItemList:
        """Редактирование карточек товаров"""
        return await UpdateContentCard(body=body).emit(self._api)

    async def update_content_cards_delete_trash(
        ...
        """
        return await UpdateContentCardsDeleteTrash(nm_ids=nm_ids).emit(self._api)

    async def update_content_cards_move_nm(self, *, body: Any) -> ResponseItemList:
        """Объединение и разъединение карточек товаров"""
        return await UpdateContentCardsMoveNm(body=body).emit(self._api)

    async def update_content_cards_recover(
        self, *, nm_ids: list[int] | None = None
    ) -> UpdateContentCardsRecoverResponse:
        ...
        :param nm_ids: Артикулы WB
        """
        return await UpdateContentCardsRecover(nm_ids=nm_ids).emit(self._api)
    ...
    async def update_content_tag(
        ...
        :param name: Имя ярлыка
        """
        return await UpdateContentTag(id_=id_, color=color, name=name).emit(self._api)
    ...
    async def upload_content_media_file(self) -> UploadContentMediaFileResponse:
        """Загрузить медиафайл"""
        return await UploadContentMediaFile().emit(self._api)

    async def upload_content_media_save(
        ...
        :param nm_id: Артикул WB
        """
        return await UploadContentMediaSave(data=data, nm_id=nm_id).emit(self._api)
