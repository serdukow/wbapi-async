...
from ...types import RequestLimit, SuppliesListResponse


class SuppliesList(WbMethod):
    """
    ...
    dates: list[Any] | None = Field(None)
    status_i_ds: list[Any] | None = Field(None, alias="statusIDs")
