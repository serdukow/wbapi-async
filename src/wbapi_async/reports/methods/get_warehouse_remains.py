...
from ...types import RequestLimit, WarehouseRemainsResponse


class GetWarehouseRemains(WbMethod):
    """
    ...
    __return__ = WarehouseRemainsResponse
    __api__ = "seller-analytics-api"
    __method__ = "api/v1/warehouse_remains"

    request_limit: RequestLimit = RequestLimit(period=60, limit=10, interval=600, burst=5)

    locale: str | None = Field("ru", alias="locale")
