...
from ...types import PaidStorageTasksTaskIdStatusResponse, RequestLimit


class GetPaidStorageTasksTaskIdStatus(WbMethod):
    """
    ...
    __return__ = PaidStorageTasksTaskIdStatusResponse
