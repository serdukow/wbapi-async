...
from ...types import DetailsForTheAcquiringExpensesReportsByPeriodResponse, RequestLimit


class DetailsForTheAcquiringExpensesReportsByPeriod(WbMethod):
    """
    ...
    __return__ = DetailsForTheAcquiringExpensesReportsByPeriodResponse
    __api__ = "finance-api"
    __method__ = "api/finance/v1/acquiring/detailed"
