...
from ...types import DetailsForTheSalesReportsByReportIdResponse, RequestLimit


class DetailsForTheSalesReportsByReportId(WbMethod):
    """
    ...
    __return__ = DetailsForTheSalesReportsByReportIdResponse
    __api__ = "finance-api"
    __method__ = ""
    __method_template__ = "api/finance/v1/sales-reports/detailed/{report_id}"
