...
from ...types import ListOfCampaignMinusPhrasesItem, RequestLimit, V0GetNormQueryMinusRequestItem


class GetListOfCampaignMinusPhrases(WbMethod):
    """
    ...
    items: list[V0GetNormQueryMinusRequestItem] = Field(alias="items")
