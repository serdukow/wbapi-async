...
from ...types import ActiveAndInactiveSearchClusterListsItem, RequestLimit, V0GetNormQueryListRequestItem


class GetActiveAndInactiveSearchClusterLists(WbMethod):
    """
    ...
    items: list[V0GetNormQueryListRequestItem] = Field(alias="items")
