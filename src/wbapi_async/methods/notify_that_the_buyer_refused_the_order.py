...
class NotifyThatTheBuyerRefusedTheOrder(WbMethod):
    """
    ...
    __return__ = NotifyThatTheBuyerRefusedTheOrderResponse
    __empty_response__ = True
    __api__ = "marketplace-api"
    __method__ = ""
    __method_template__ = "api/v3/click-collect/orders/{order_id}/reject"
