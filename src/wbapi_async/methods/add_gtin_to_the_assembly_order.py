...
class AddGtinToTheAssemblyOrder(WbMethod):
    ...
    Source: https://dev.wildberries.ru/en/docs/openapi/in-store-pickup#tag/In-Store-Pickup-Metadata/paths/~1api~1v3~1click-collect~1orders~1%7BorderId%7D~1meta~1gtin/put
    """
    ...
    __method__ = ""
    __method_template__ = "api/v3/click-collect/orders/{order_id}/meta/gtin"
    __http_method__ = "PUT"
