...
class CancelTheAssemblyOrder(WbMethod):
    ...
    Source: https://dev.wildberries.ru/en/docs/openapi/in-store-pickup#tag/In-Store-Pickup-Assembly-Orders/paths/~1api~1v3~1click-collect~1orders~1%7BorderId%7D~1cancel/patch
    """
    ...
    __method__ = ""
    __method_template__ = "api/v3/click-collect/orders/{order_id}/cancel"
